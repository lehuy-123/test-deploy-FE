...
const AdminUsersPage = () => {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`https://test-deploy-be.render.com/api/users?search=${search}&page=${page}`, {
  ...
  const handleToggleBlock = async (id) => {
    try {
      await axios.patch(`https://test-deploy-be.render.com/api/users/${id}/block`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchUsers();
    } catch (err) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://test-deploy-be.render.com/api/users/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchUsers();
    } catch (err) {
  ...
  const handleToggleRole = async (id, currentRole) => {
    ...
    try {
      await axios.patch(`https://test-deploy-be.render.com/api/users/${id}/role`, {
        role: newRole
      }, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSaveEdit = async (id) => {
    try {
      await axios.patch(`https://test-deploy-be.render.com/api/users/${id}/info`, {
        name: editName,
        email: editEmail
      }, {
        headers: { Authorization: `Bearer ${token}` }
